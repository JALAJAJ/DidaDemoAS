 ...
 * @use
 */
public class PopupWindowParam extends PopupWindowBaseDown<List<BeanDetailMarket.ResEntity.ProductCustomAttrListEntity>> {
    ...
    public PopupWindowParam(View parentView, Activity activity,
                            List<BeanDetailMarket.ResEntity.ProductCustomAttrListEntity> data) {
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        private List<BeanDetailMarket.ResEntity.ProductCustomAttrListEntity> list;

        public MyAdapter(List<BeanDetailMarket.ResEntity.ProductCustomAttrListEntity> list) {
