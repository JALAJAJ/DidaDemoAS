 ...
 * @use
 */
public class Detail_Group_Activity extends BaseNomalActivity implements OnShareFavListener{
    ...
    protected void onChildClick(View v) {
        switch (v.getId()) {
            case R.id.rl_pingou_detail_team_more:
                ActivityUtil.goActivity(Detail_Group_Activity.this,AttentionActivity.class);
                break;
        }
    }
    ...
    protected View setView() {
        ...
        itemHolder = new GDetail_Item_Holder();
