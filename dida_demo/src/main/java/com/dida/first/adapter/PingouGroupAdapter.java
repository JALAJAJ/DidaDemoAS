 ...
 * 拼购已经参与的团员列表
 */
public class PingouGroupAdapter extends BaseLvGvAdapter<BeanDetailPingouUser.ResEntity.ComGroupDetailEntity.ParticipatesEntity> {
    public PingouGroupAdapter(List<BeanDetailPingouUser.ResEntity.ComGroupDetailEntity.ParticipatesEntity> list, Activity activity) {
        super(list, activity);
    }
