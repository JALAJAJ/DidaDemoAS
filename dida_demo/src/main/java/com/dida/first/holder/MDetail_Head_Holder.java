...
public class MDetail_Head_Holder extends BaseHolder implements OnClickListener{
	...
	private LinearLayout ll_market_detail_head_favorite;
	...
	public View initView() {
		...
		iv_market_detail_head_icon = (ImageView) view.findViewById(R.id.iv_market_detail_head_icon);
		...
		ll_market_detail_head_favorite = (LinearLayout) view.findViewById(R.id.ll_market_detail_head_favorite);
	...
	public void refreshView() {
		...
		iv_market_detail_head_icon.setOnClickListener(this);
		initUrl();
		initViewPager(context, urlList, rl_market_head_lunbotu);
	...
	public void onClick(View v) {
		...
		case R.id.ll_market_detail_head_favorite:
			...
			break;
		case R.id.iv_market_detail_head_icon:
			ToastUtil.showMyToast("卖家头像");
			break;
		default:
			break;
		}
