 ...
 *
 */
public class MDetail_Store_Holder extends BaseHolder implements OnClickListener{
	...
	private TextView tv_market_detail_store_des;
	...
	private void init() {
		...
		tv_market_detail_store_des = (TextView) view.findViewById(R.id.tv_market_detail_store_des);
